...
export default function Portfolio() {
	...
	return (
		<div className="flex h-[92vh] w-screen flex-col content-center items-center bg-raisin-black">
			<h1 className="m-4 text-4xl font-bold text-custom-2 md:text-7xl">
				PROJECTS
			</h1>
			<Divider />
					...
					>
						<motion.div id="project-card-title">
							<div className="m-3 auto-rows-auto">
								<h1 className="h-auto pr-4 align-middle text-4xl font-bold text-custom-2">
						...
						<motion.div id="project-card-text">
							<div className="mb-3 ml-3 mr-3 grow auto-rows-auto pt-4">
								<p className="h-auto grow overflow-auto text-base font-medium text-custom-2 md:text-xl">
									{projectsData[index].text}
								</p>
							</div>
						</motion.div>
					</Card>
										...
										>
											...
											<div className=" absolute inset-0 flex h-full w-full flex-col-reverse">
													...
													{projectsData[index].tags.map((tag, tagIndex) => (
														<Chip
															...
															classNames={{
																...
																content: "text-custom-2 text-base",
															}}
															key={tagIndex}
														>
															{tag}
												...
												<div className="pb-1 pl-14">
													<div className="">
														<h1 className="ml-1 h-auto pr-4 align-middle text-2xl font-bold text-custom-2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
															{projectsData[index].name}
														</h1>
													</div>
												</div>
